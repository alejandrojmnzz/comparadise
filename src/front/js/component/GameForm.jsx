    ...
    <form onSubmit={handleSubmit}>
      <div className="ps-3 pe-3">
          ...
          <div className="col">
            ...
            <div className="col">
              <label>Additional Images: (min. 4 images size 290px x 180px)</label>
              <input
              className="form-control"
              type="file" 
          ...
          <div className="third-part row">
            <div className="col">
              <label>Summary:</label>
              <input className="form-control" type="text" name="summary" value={formData.summary} onChange={handleChange} />
            </div>
