...
//form info
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="col">
        <label>
          Cover Image:(it must be size 228px x 342px)
          <input 
          type="file" 
          name="cover_image" 
          onChange={(event) => {
        ...
        <div className="col">
          <label>Additional Images: (the must be size 290px x 180px, add 4 images)</label>
          <input
          type="file" 
      ...
      <div className="third-part row">
        ...
        <div className="col">
        <label>PEGI:</label>
          <select name="pegi" value={formData.pegi} onChange={handleChange} required aria-label="Select a PEGI">
      ...
      <div className="col"></div>
        <button className="col justify-content-center" type="submit">Submit</button>
      <div className="col"></div>
      </div>
    </form>
  );
